...
class DataTransformationConfig:
    preprocessesor_obj_file_path=os.path.join('artifacts',"preprocessor.pkl")
...
class DataTransformtion:
    ...
    def initiate_data_transformation(self,train_path,test_path):
            ...
            try:
                ...
                logging.info(f"Applying the preprocessing object on train dataset and test dataset")
                ...
                save_object(
                    file_path=self.data_transformation_config.preprocessesor_obj_file_path,
                ...
                return(
                    train_arr,
                    test_arr,
                    self.data_transformation_config.preprocessesor_obj_file_path,
                )
